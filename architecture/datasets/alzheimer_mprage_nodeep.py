...
RAW_DATA_DIRNAME = Dataset.data_dirname() / 'raw' / 'alzheimer_mprage_nodeep'
RAW_DATA_FILENAME = Dataset.data_dirname() / 'raw' / 'alzheimer_mprage_nodeep' / 'alzheimer_mprage_nodeep.zip'
METADATA_FILENAME = RAW_DATA_DIRNAME / 'metadata.toml'

PROCESSED_DATA_DIRNAME = Dataset.data_dirname() / 'processed' / 'alzheimer_mprage_nodeep'
...
class AlzheimerMPRageNoDeep(Dataset):
    ...
    def load_or_generate_data(self):
        if 'alzheimer_mprage_nodeep' not in os.listdir(os.path.join('data', 'processed')):
