...
RAW_DATA_DIRNAME = Dataset.data_dirname() / 'raw' / 'alzheimer_t2mri_small'
RAW_DATA_FILENAME = Dataset.data_dirname() / 'raw' / 'alzheimer_t2mri_small' / 'alzheimer_t2mri_small.zip'
METADATA_FILENAME = RAW_DATA_DIRNAME / 'metadata.toml'

PROCESSED_DATA_DIRNAME = Dataset.data_dirname() / 'processed' / 'alzheimer_t2mri_small'
