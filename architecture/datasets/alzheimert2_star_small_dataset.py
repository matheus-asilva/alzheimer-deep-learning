...
RAW_DATA_DIRNAME = Dataset.data_dirname() / 'raw' / 'alzheimer_t2mri_star_small'
RAW_DATA_FILENAME = Dataset.data_dirname() / 'raw' / 'alzheimer_t2mri_star_small' / 'alzheimer_t2mri_star_small.zip'
METADATA_FILENAME = RAW_DATA_DIRNAME / 'metadata.toml'

PROCESSED_DATA_DIRNAME = Dataset.data_dirname() / 'processed' / 'alzheimer_t2mri_star_small'
...
class AlzheimerT2StarSmallDataset(Dataset):
    ...
    def load_or_generate_data(self):
        if 'alzheimer_t2mri_star_small' not in os.listdir(os.path.join('data', 'processed')):
